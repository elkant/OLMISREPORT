 ...
 * @author Manuel
 */
public class CHVReportingRatesSummary extends HttpServlet {
 ...
 String allpath = getServletContext().getRealPath("/CHVReportingRatesSummary.xlsm");
 String spath = getServletContext().getRealPath("/CHVReportingRatesSummary.xlsm");
  ...
  System.out.println("3 open of excel finished");  
    XSSFSheet rawdata = wb.getSheet("Sheet1");
           ...
           // dbConn1 conn1 = new dbConn1();
            ...
            conn.ps1 = conn.connect.prepareCall("{call	rpt_chvreportingrates_summary(?,?,?)}");
...
//"OVCID","MonthofService","YearofService","CBO","District","Gender","AgeBracket","CHWName","ActiveOVCs"
//"OVCServed","MonthofService","YearofService","CBO","District","Gender","AgeBracket","CHWName","ActiveOVCs"
       ...
       // response.sendRedirect("index.jsp");
            ...
            Logger.getLogger(CHVReportingRatesSummary.class.getName()).log(Level.SEVERE, null, ex);

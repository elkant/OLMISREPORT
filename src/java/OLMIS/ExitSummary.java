 ...
 * @author Manuel
 */
public class ExitSummary extends HttpServlet {
 ...
 String allpath = getServletContext().getRealPath("/ExitsSummary.xlsm");
 String spath = getServletContext().getRealPath("/ExitsSummary.xlsm");

    String mydrive = allpath.substring(0, 1);
        //dbconnpath=mydrive+":\\MNHC_SYSTEM_APHIA_PLUS\\"; 
      allpath=mydrive+":\\APHIAPLUS\\OLMIS\\MACROS\\ExitsSummary.xlsm"; 
    String  np=mydrive+":\\APHIAPLUS\\OLMIS\\MACROS\\ExitsSummary.xlsm"; 
...
String dat1 = dat.toString().replace(" ", "_");
 dat1 = dat1.toString().replace(":", "_");
   ...
   String perminpath=mydrive+":\\APHIAPLUS\\OLMIS\\MACROS\\ExitsSummary"+dat1+".xlsm";  
  ...
  System.out.println("3 open of excel finished");  
    XSSFSheet rawdata = wb.getSheet("Sheet1");
           ...
           // dbConn1 conn1 = new dbConn1();
            ...
            conn.ps1 = conn.connect.prepareCall("{call	rpt_exitssummary(?,?,?)}");
...
////conn.ps1.setQueryTimeout(30000);
           ...
           // cell2.setCellStyle(innerdata_style);
            ...
            //"YearofExit","HidingReason.HidingReason","CBO.CBO","District.District","Clientdetails.Gender
       ...
       // response.sendRedirect("index.jsp");
            ...
            Logger.getLogger(ExitSummary.class.getName()).log(Level.SEVERE, null, ex);

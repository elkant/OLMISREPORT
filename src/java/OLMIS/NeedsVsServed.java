 ...
 * @author Manuel
 */
public class NeedsVsServed extends HttpServlet {
 ...
 String allpath = getServletContext().getRealPath("/NeedsVsServedSummary.xlsm");
 String spath = getServletContext().getRealPath("/NeedsVsServedSummary.xlsm");

    String mydrive = allpath.substring(0, 1);
        //dbconnpath=mydrive+":\\MNHC_SYSTEM_APHIA_PLUS\\"; 
      allpath=mydrive+":\\OLMIS\\OLMIS\\MACROS\\NeedsVsServedSummary.xlsm"; 
    String  np=mydrive+":\\OLMIS\\OLMIS\\MACROS\\NeedsVsServedSummary.xlsm"; 
...
String dat1 = dat.toString().replace(" ", "_");
 dat1 = dat1.toString().replace(":", "_");
   ...
   String perminpath=mydrive+":\\OLMIS\\OLMIS\\MACROS\\NeedsVsServedSummary"+dat1+".xlsm";  
...
String columnheaders[]={"OVCCount","Domain","Gender","CBO","District","County","NeedsorServices"};
  ...
  System.out.println("3 open of excel finished");  
    Sheet rawdata = wb.getSheet("Sheet1");
           ...
           // dbConn1 conn1 = new dbConn1();
            ...
            conn.ps1 = conn.connect.prepareCall("{call	rpt_NeedsVsServed(?,?,?)}");
...
//Clientdetails.OVCID,Clientdetails.FirstName,Clientdetails.MiddleName,Clientdetails.Surname,Clientdetails.Gender,DateofBirth,age,BirthCert,HIVStatus.HIVStatus,CHWFirstName,CHWMiddleName,CHWSurname,CHWNationalID,ParentNationalIDNumber,ParentDetailsFirstName,ParentDetailsMiddleName,ParentDetailsSurname,SchoolLevel.SchoolLevel,Schools.SchoolName,DateofRegistration,ExitStatus,ReasonforExit,DateofExit,Immunization.ImmunizationStatus,Clientdetails.HHVulnerabilityStatus,CBO.CBO,District.District,Location.Location,County.County
        ...
        response.setHeader("Content-Disposition", "attachment; filename=NeedsVsServed_Btwn_"+startdate.replace(" ","")+"_and_"+enddate.replace(" ","")+"_Generated_On_" + dat1 + "_.xlsm");
       ...
       // response.sendRedirect("index.jsp");
            ...
            Logger.getLogger(NeedsVsServed.class.getName()).log(Level.SEVERE, null, ex);

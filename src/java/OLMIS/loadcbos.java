...
public class loadcbos extends HttpServlet {
   ...
   String allcbos="";
    ...
    allcbos="<option value=\"\">select option</option>";
    allcbos+="<option value=\"all\">all cbos</option>";
    
    response.setContentType("text/html;charset=UTF-8");
    
    String getcbos="select * from CBO order by cbo ";
        ...
        allcbos+="<option value=\""+conn.rs.getString(1) +"\">"+conn.rs.getString(2) +"</option>";
